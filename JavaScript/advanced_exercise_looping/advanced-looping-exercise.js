/*
 * for of -- works with arrays/strings
 * for (item of basket) { console.log(item); }
 * -- iterating
 * 
 * for in -- works with objects
 * will work arrays since js arrays are like objects; the property is the index
 * 
 * const detailedBasket = { apples: 5, oranges: 10, grapes: 1000 }
 * for (item in detailedBasket) { console.log(item) }; 
 * for in allows us to loop through and see object properties
 * -- enumerating
 * 
 */
